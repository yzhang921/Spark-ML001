...
object RunIntro extends Serializable {
  def main(args: Array[String]): Unit = {
    ...
    //val rawblocks = sc.textFile("hdfs://ns/user/bifin/data/aaws/block_1.csv")

    val rawblocks = sc.textFile("D:/Research/BI@Home/SparkClass/Advanced Analytics With " +
      "Spark/data/02/donation/block_1.csv")
